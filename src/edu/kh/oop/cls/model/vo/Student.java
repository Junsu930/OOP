...
//[접근제한자]public : 같은 프로젝트 내에서 어떤 클래스에서든 import 할 수 있음을 나타냄
	...
	// == 멤버 변수를 작성하는 곳 : 메서드 밖에 작성된 변수
	//		1) 인스턴스 변수 : 필드에 작성되는 일반 변수 (객체 미생성시 사용 불가)
	// 		2) 클래스 변수( == static 변수) : 필드에 static 예약어가 작성된 변수 (객체 생성 안 해도 쓸 수 있음)
	...
	private String name; // 캡슐화 원칙 private -> 간접 접근 방법 필요
	{
	...
	public void setName(/*매개 변수*/String name) {
		this.name = name;
	}
	// =========================================
	/*
